...
LENDING_POOL_INTERFACE_CONFIGS = {
    Network.MAINNET: [
        LendingPoolInterfaceConfig(
            ...
            841194726,
            841170409,
            PoolType.NANOSWAP_LENDING_POOL,
            841189050,
        ),  # bUSDC / bSTBL2
        LendingPoolInterfaceConfig(
            856198764,
        ...
        LendingPoolInterfaceConfig(
            ...
            PoolType.CONSTANT_PRODUCT_25BP_FEE_LENDING_POOL,
            841189050
        ),  # bSTBL2 / bBANK ( has no LP market this is a dummy)
        LendingPoolInterfaceConfig(
            919954173,
            1,
            31566704,
            ...
            PoolType.CONSTANT_PRODUCT_25BP_FEE_LENDING_POOL,
            841189050
        ),  # bALGO / bUSDC ( has no LP market this is a dummy)
        LendingPoolInterfaceConfig(
            962381193,
            1,
            900652777,
            ...
            PoolType.CONSTANT_PRODUCT_25BP_FEE_LENDING_POOL,
            841189050
        ),  # bALGO / bBANK ( has no LP market this is a dummy)
    ],
    Network.TESTNET: [
        LendingPoolInterfaceConfig(
            104532133,
